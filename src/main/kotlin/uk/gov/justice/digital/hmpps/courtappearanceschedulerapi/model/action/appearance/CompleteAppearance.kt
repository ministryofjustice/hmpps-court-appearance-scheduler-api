...
object CompleteAppearance : CourtAppearanceAction {
  override fun domainEvent(ca: CourtAppearance): DomainEvent<*> = CourtAppearanceCompleted(ca.person.identifier, ca.id, ca.externalReference)
}
