# hmpps-court-appearance-scheduler-api

[![Ministry of Justice Repository Compliance Badge](https://github-community.service.justice.gov.uk/repository-standards/api/hmpps-court-appearance-scheduler-api/badge?style=flat)](https://github-community.service.justice.gov.uk/repository-standards/hmpps-court-appearance-scheduler-api)
[![Docker Repository on ghcr](https://img.shields.io/badge/ghcr.io-repository-2496ED.svg?logo=docker)](https://ghcr.io/ministryofjustice/hmpps-court-appearance-scheduler-api)
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://court-appearance-scheduler-api-dev.hmpps.service.justice.gov.uk/swagger-ui/index.html)

Database Schema diagram: https://ministryofjustice.github.io/hmpps-court-appearance-scheduler-api/schema-spy-report
...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-court-appearance-scheduler-api/security/policy).
...
## Renaming from HMPPS Court Appearance Scheduler Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-court-appearance-scheduler-api=0
```
